  ...
  POST: [
    ...
    async ({
      ...
      res
        ...
        //ici je supprime la machine virtuel present dans mon groupe de ressource
        try {
           await computeClient.virtualMachines.beginDeleteAndWait(resourceGroupName, nameVM)
